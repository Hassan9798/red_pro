    ...
    <main className="w-full h-full flex flex-col gap-6 xl:gap-8 relative">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Packaging Policy</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      <div className="py-8 lg:py-12 w-full flex flex-col gap-8">
        <div className="flex flex-col gap-6">
          <h1 className="text-4xl lg:text-6xl font-bold">Packaging Policy</h1>
          <p>
            These Terms and Conditions ("Terms") govern your use of the website,
            mobile application, and services provided by [Company Name] ("we,"
            "us," or "our"). By accessing or using our website, mobile
            application, or services, you agree to be bound by these Terms. If
...
export default PackagingPolicyPage;
